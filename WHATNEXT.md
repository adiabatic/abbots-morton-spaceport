...
- **·No·Utter·Day** — the identical 2-vs-2 tie to the landed ·No·Utter·May tie-breaker, left mono to honor the note’s ·May scope; widen the peek to `then: {family: [qsDay, qsMay]}` if the taste extends. Relatedly, the records landed in this round (qsNo’s before-·Utter·May tie-breaker, qsDay’s ·Day·Tea withdrawal pair) still carry no `why:` text.
