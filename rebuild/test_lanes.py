...
class TestForbiddenPaths:
    @pytest.mark.parametrize(
        ...
        [
            ...
            "rebuild/out",
            "tmp/review-surface-test-cache/abc/DONE",
            "tmp/review-enrich-test-cache/abc/units.pickle.gz",
            "tmp/review-workload-test-cache",
            "tmp/review-pre-abc1234/manifest.json",
            "tmp/scratch.txt",
