...
class TestFilterTable:
    def test_keeps_subset_rows_and_header(self, tmp_path):
        ...
        rows = [
            "E670\tqsIt\t0\t\t0,0,150",
            "E654\tqsKey\t0\t\t0,0,250",
            "E652:E670\tqsTea.half.ex-y5|qsIt.en-y5.ex-y0\t0,1\ty5\t0,0,100|0,0,100",
            "E652:E654\tqsTea|qsKey\t0,1\tbreak\t0,0,100|0,0,250",
        ]
...
def _seed_repo(tmp_path):
    ...
    _write_table(out / "baseline-default.tsv.gz", ["E670\tqsIt\t0\t\t0,0,150", "E654\tqsKey\t0\t\t0,0,250"])
...
class TestEnsureFresh:
    ...
    def test_a_source_table_change_reads_as_stale_and_refilters(self, tmp_path):
        ...
        _write_table(
            ...
            ["E670\tqsIt\t0\t\t0,0,150", "E654\tqsKey\t0\t\t0,0,250", "E672\tqsEt\t0\t\t0,0,200"],
        )
...
class TestFilterTriage:
    def test_filters_on_the_codepoints_column(self, tmp_path):
        ...
        source.write_text(
            ...
            "default\tzwnj-vs-edge\t200C:E654\ta\tb\t0\tx\ty\tname\n"
        )
