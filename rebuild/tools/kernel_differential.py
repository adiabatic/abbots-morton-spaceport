...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--skip-corpus", action="store_true", help="skip the golden-corpus arm and its kernel enumerations"
    )
