...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        default=1,
        metavar="N",
        help="how many worker processes the standing fill refills a dropped memo across (its --jobs); 1 is the serial fill. The artifact cycle states it from its own box arithmetic (standing_fill_jobs in rebuild/tools/artifact_cycle.py)",
    )
    parser.add_argument(
        "--no-merge",
        action="store_true",
