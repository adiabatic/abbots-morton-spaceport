...
def _composed_walk(rules, unit, context):
    ...
    behind_join = {
        ...
        and index + 1 in events
        and events[index + 1].kind in ("joined", "retarget", "extension", "redrawn")
    }
    if any(
