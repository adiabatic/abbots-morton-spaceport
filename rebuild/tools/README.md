...
| Script                 | Purpose                                                                                                                                                                                                      |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `artifact_cycle.py`    | The commit-time artifact cycle (`make artifact-cycle`): snapshot, `run_m1`, surface rebuild, verdict carry and merge, echo/standing fills, census re-pin, complaints, gates; stages skip on unchanged inputs |
