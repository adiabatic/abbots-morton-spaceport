...
def _emit_quikscript_calt(analysis: _JoinAnalysis) -> str | None:
    ...
    def _emit_narrow_mid_entry_strip_guards(
        ...
        *,
        ...
        fwd_strip_bases = (
            derived_strip_bases if _fwd_strip_guards_active[0] else frozenset()
        )
                ...
                for fwd_variant in sorted(fwd_exit_only):
                    ...
                    if (
                        ...
                        if not (
                            use_excl
                            and (
                                fwd_exit_y not in entry_exclusive
                                or not entry_exclusive[fwd_exit_y]
                            )
                        ):
                            right_context = set(
                                entry_exclusive[fwd_exit_y]
                                if use_excl
                                else entry_classes[fwd_exit_y]
                            )
