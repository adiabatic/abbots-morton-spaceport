...
keep=set(base[:KEEP]); keep={n for n in keep if not spec.runes[n].sequence or set(spec.runes[n].sequence)<=keep}
        ...
        def wrapper(self,*a,**k):
            ...
            if depth[0]==0:
                ...
                try: return orig(self,*a,**k)
                    ...
                    acc[meth][1]+=time.perf_counter()-t; depth[0]=0
