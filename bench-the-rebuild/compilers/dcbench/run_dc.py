...
out = {
    "label": sys.argv[1],
    "native_module": dckernel.__file__.endswith(".so"),
    "n": N,
    "dataclass_dunder_is_interpreted": getattr(dckernel.Frozen.__dict__["__init__"], "__code__", None)
    is not None
