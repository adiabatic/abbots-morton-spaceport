...
- Document stylistic sets (ss01 = suppress ·Utter ~x~ ·Pea join, ss02 = full-size ·Tea entry at x-height after ·I, ss03 = allow ·It to join at the same height for both entry and exit)
