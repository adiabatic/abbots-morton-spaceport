...
- **Bitmap** — the concrete grid of on/off pixels that draws a rune one particular way. A rune has one or more bitmaps — ·May, drawn counterclockwise or clockwise, needs two. (A filled pixel is "ink"; the font's strokes are made of ink.)
